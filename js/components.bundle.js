...
var n = class {
  ...
  get styleSheet() {
    ...
    if (e && void 0 === t3) {
      ...
      e7 && (t3 = o.get(s5)), void 0 === t3 && ((this.o = t3 = new CSSStyleSheet()).replaceSync(this.cssText), e7 && o.set(s5, t3));
    }
    return t3;
  }
  toString() {
...
var S = (s5, o10) => {
  if (e) s5.adoptedStyleSheets = o10.map((t3) => t3 instanceof CSSStyleSheet ? t3 : t3.styleSheet);
  else for (const e7 of o10) {
    const o11 = document.createElement("style"), n6 = t.litNonce;
    void 0 !== n6 && o11.setAttribute("nonce", n6), o11.textContent = e7.cssText, s5.appendChild(o11);
  }
};
var c = e ? (t3) => t3 : (t3) => t3 instanceof CSSStyleSheet ? ((t4) => {
  let e7 = "";
  for (const s5 of t4.cssRules) e7 += s5.cssText;
  return r(e7);
})(t3) : t3;
...
var y = class extends HTMLElement {
  ...
  static createProperty(t3, s5 = b) {
    if (s5.state && (s5.attribute = false), this._$Ei(), this.prototype.hasOwnProperty(t3) && ((s5 = Object.create(s5)).wrapped = true), this.elementProperties.set(t3, s5), !s5.noAccessor) {
      const i7 = Symbol(), h3 = this.getPropertyDescriptor(t3, i7, s5);
      void 0 !== h3 && e2(this.prototype, t3, h3);
    }
  }
  static getPropertyDescriptor(t3, s5, i7) {
    const { get: e7, set: r6 } = h(this.prototype, t3) ?? { get() {
      return this[s5];
    }, set(t4) {
      this[s5] = t4;
    } };
    return { get: e7, set(s6) {
      ...
      r6?.call(this, s6), this.requestUpdate(t3, h3, i7);
  ...
  static finalize() {
    ...
    if (this.finalized = true, this._$Ei(), this.hasOwnProperty(d("properties"))) {
      ...
      for (const i7 of s5) this.createProperty(i7, t4[i7]);
    }
    const t3 = this[Symbol.metadata];
    if (null !== t3) {
      const s5 = litPropertyMetadata.get(t3);
      if (void 0 !== s5) for (const [t4, i7] of s5) this.elementProperties.set(t4, i7);
    }
    this._$Eh = /* @__PURE__ */ new Map();
    for (const [t4, s5] of this.elementProperties) {
      const i7 = this._$Eu(t4, s5);
  ...
  _$E_() {
    ...
    for (const i7 of s5.keys()) this.hasOwnProperty(i7) && (t3.set(i7, this[i7]), delete this[i7]);
  ...
  attributeChangedCallback(t3, s5, i7) {
    this._$AK(t3, i7);
  }
  _$ET(t3, s5) {
    const i7 = this.constructor.elementProperties.get(t3), e7 = this.constructor._$Eu(t3, i7);
    if (void 0 !== e7 && true === i7.reflect) {
      const h3 = (void 0 !== i7.converter?.toAttribute ? i7.converter : u).toAttribute(s5, i7.type);
      this._$Em = t3, null == h3 ? this.removeAttribute(e7) : this.setAttribute(e7, h3), this._$Em = null;
    }
  }
  _$AK(t3, s5) {
    const i7 = this.constructor, e7 = i7._$Eh.get(t3);
    if (void 0 !== e7 && this._$Em !== e7) {
      const t4 = i7.getPropertyOptions(e7), h3 = "function" == typeof t4.converter ? { fromAttribute: t4.converter } : void 0 !== t4.converter?.fromAttribute ? t4.converter : u;
      this._$Em = e7;
      const r6 = h3.fromAttribute(s5, t4.type);
      this[e7] = r6 ?? this._$Ej?.get(e7) ?? r6, this._$Em = null;
    }
  }
  requestUpdate(t3, s5, i7) {
    if (void 0 !== t3) {
      const e7 = this.constructor, h3 = this[t3];
      if (i7 ??= e7.getPropertyOptions(t3), !((i7.hasChanged ?? f)(h3, s5) || i7.useDefault && i7.reflect && h3 === this._$Ej?.get(t3) && !this.hasAttribute(e7._$Eu(t3, i7)))) return;
      this.C(t3, s5, i7);
    }
    false === this.isUpdatePending && (this._$ES = this._$EP());
  }
  C(t3, s5, { useDefault: i7, reflect: e7, wrapped: h3 }, r6) {
    i7 && !(this._$Ej ??= /* @__PURE__ */ new Map()).has(t3) && (this._$Ej.set(t3, r6 ?? s5 ?? this[t3]), true !== h3 || void 0 !== r6) || (this._$AL.has(t3) || (this.hasUpdated || i7 || (s5 = void 0), this._$AL.set(t3, s5)), true === e7 && this._$Em !== t3 && (this._$Eq ??= /* @__PURE__ */ new Set()).add(t3));
  }
  async _$EP() {
  ...
  performUpdate() {
    ...
    if (!this.hasUpdated) {
      ...
      if (t4.size > 0) for (const [s6, i7] of t4) {
        const { wrapped: t5 } = i7, e7 = this[s6];
        true !== t5 || this._$AL.has(s6) || void 0 === e7 || this.C(s6, void 0, i7, e7);
      }
    }
    let t3 = false;
    const s5 = this._$AL;
...
var y2 = (t3) => (i7, ...s5) => ({ _$litType$: t3, strings: i7, values: s5 });
var x = y2(1);
var b2 = y2(2);
var w = y2(3);
...
var V = (t3, i7) => {
  const s5 = t3.length - 1, o10 = [];
  let r6, l6 = 2 === i7 ? "<svg>" : 3 === i7 ? "<math>" : "", c5 = f2;
  for (let i8 = 0; i8 < s5; i8++) {
    const s6 = t3[i8];
    let a5, u4, d5 = -1, y5 = 0;
    for (; y5 < s6.length && (c5.lastIndex = y5, u4 = c5.exec(s6), null !== u4); ) y5 = c5.lastIndex, c5 === f2 ? "!--" === u4[1] ? c5 = v : void 0 !== u4[1] ? c5 = _ : void 0 !== u4[2] ? ($.test(u4[2]) && (r6 = RegExp("</" + u4[2], "g")), c5 = m) : void 0 !== u4[3] && (c5 = m) : c5 === m ? ">" === u4[0] ? (c5 = r6 ?? f2, d5 = -1) : void 0 === u4[1] ? d5 = -2 : (d5 = c5.lastIndex - u4[2].length, a5 = u4[1], c5 = void 0 === u4[3] ? m : '"' === u4[3] ? g : p2) : c5 === g || c5 === p2 ? c5 = m : c5 === v || c5 === _ ? c5 = f2 : (c5 = m, r6 = void 0);
    const x3 = c5 === m && t3[i8 + 1].startsWith("/>") ? " " : "";
    l6 += c5 === f2 ? s6 + n3 : d5 >= 0 ? (o10.push(a5), s6.slice(0, d5) + e3 + s6.slice(d5) + h2 + x3) : s6 + h2 + (-2 === d5 ? i8 : x3);
  }
  return [P(t3, l6 + (t3[s5] || "<?>") + (2 === i7 ? "</svg>" : 3 === i7 ? "</math>" : "")), o10];
};
var N = class _N {
  constructor({ strings: t3, _$litType$: s5 }, n6) {
    ...
    this.parts = [];
    let c5 = 0, a5 = 0;
    const u4 = t3.length - 1, d5 = this.parts, [f6, v5] = V(t3, s5);
    if (this.el = _N.createElement(f6, n6), C.currentNode = this.el.content, 2 === s5 || 3 === s5) {
      const t4 = this.el.content.firstChild;
      t4.replaceWith(...t4.childNodes);
    }
    for (; null !== (r6 = C.nextNode()) && d5.length < u4; ) {
      if (1 === r6.nodeType) {
        if (r6.hasAttributes()) for (const t4 of r6.getAttributeNames()) if (t4.endsWith(e3)) {
          const i7 = v5[a5++], s6 = r6.getAttribute(t4).split(h2), e7 = /([.?@])?(.*)/.exec(i7);
          d5.push({ type: 1, index: c5, name: e7[2], strings: s6, ctor: "." === e7[1] ? H : "?" === e7[1] ? I : "@" === e7[1] ? L : k }), r6.removeAttribute(t4);
        } else t4.startsWith(h2) && (d5.push({ type: 6, index: c5 }), r6.removeAttribute(t4));
        if ($.test(r6.tagName)) {
          const t4 = r6.textContent.split(h2), s6 = t4.length - 1;
          if (s6 > 0) {
            r6.textContent = i3 ? i3.emptyScript : "";
            for (let i7 = 0; i7 < s6; i7++) r6.append(t4[i7], l2()), C.nextNode(), d5.push({ type: 2, index: ++c5 });
            r6.append(t4[s6], l2());
          }
        }
      } else if (8 === r6.nodeType) if (r6.data === o3) d5.push({ type: 2, index: c5 });
      else {
        let t4 = -1;
        for (; -1 !== (t4 = r6.data.indexOf(h2, t4 + 1)); ) d5.push({ type: 7, index: c5 }), t4 += h2.length - 1;
      }
      c5++;
    }
  }
...
function S2(t3, i7, s5 = t3, e7) {
  if (i7 === T) return i7;
  let h3 = void 0 !== e7 ? s5._$Co?.[e7] : s5._$Cl;
  const o10 = c3(i7) ? void 0 : i7._$litDirective$;
  return h3?.constructor !== o10 && (h3?._$AO?.(false), void 0 === o10 ? h3 = void 0 : (h3 = new o10(t3), h3._$AT(t3, s5, e7)), void 0 !== e7 ? (s5._$Co ??= [])[e7] = h3 : s5._$Cl = h3), void 0 !== h3 && (i7 = S2(t3, h3._$AS(t3, i7.values), h3, e7)), i7;
}
var M = class {
  constructor(t3, i7) {
  ...
  u(t3) {
    const { el: { content: i7 }, parts: s5 } = this._$AD, e7 = (t3?.creationScope ?? r3).importNode(i7, true);
    C.currentNode = e7;
    let h3 = C.nextNode(), o10 = 0, n6 = 0, l6 = s5[0];
    for (; void 0 !== l6; ) {
      if (o10 === l6.index) {
        let i8;
        2 === l6.type ? i8 = new R(h3, h3.nextSibling, this, t3) : 1 === l6.type ? i8 = new l6.ctor(h3, l6.name, l6.strings, this, t3) : 6 === l6.type && (i8 = new z(h3, this, t3)), this._$AV.push(i8), l6 = s5[++n6];
      }
      o10 !== l6?.index && (h3 = C.nextNode(), o10++);
    }
    return C.currentNode = r3, e7;
  }
  p(t3) {
    let i7 = 0;
    for (const s5 of this._$AV) void 0 !== s5 && (void 0 !== s5.strings ? (s5._$AI(t3, s5, i7), i7 += s5.strings.length - 2) : s5._$AI(t3[i7])), i7++;
  }
};
var R = class _R {
  get _$AU() {
  ...
  constructor(t3, i7, s5, e7) {
    this.type = 2, this._$AH = E, this._$AN = void 0, this._$AA = t3, this._$AB = i7, this._$AM = s5, this.options = e7, this._$Cv = e7?.isConnected ?? true;
  }
  get parentNode() {
  ...
  $(t3) {
    const { values: i7, _$litType$: s5 } = t3, e7 = "number" == typeof s5 ? this._$AC(t3) : (void 0 === s5.el && (s5.el = N.createElement(P(s5.h, s5.h[0]), this.options)), s5);
    if (this._$AH?._$AD === e7) this._$AH.p(i7);
    else {
      const t4 = new M(e7, this), s6 = t4.u(this.options);
      t4.p(i7), this.T(s6), this._$AH = t4;
    }
  }
  _$AC(t3) {
  ...
  k(t3) {
    ...
    const i7 = this._$AH;
    let s5, e7 = 0;
    for (const h3 of t3) e7 === i7.length ? i7.push(s5 = new _R(this.O(l2()), this.O(l2()), this, this.options)) : s5 = i7[e7], s5._$AI(h3), e7++;
...
var k = class {
  ...
  constructor(t3, i7, s5, e7, h3) {
    this.type = 1, this._$AH = E, this._$AN = void 0, this.element = t3, this.name = i7, this._$AM = e7, this.options = h3, s5.length > 2 || "" !== s5[0] || "" !== s5[1] ? (this._$AH = Array(s5.length - 1).fill(new String()), this.strings = s5) : this._$AH = E;
  }
  _$AI(t3, i7 = this, s5, e7) {
    const h3 = this.strings;
    let o10 = false;
    if (void 0 === h3) t3 = S2(this, t3, i7, 0), o10 = !c3(t3) || t3 !== this._$AH && t3 !== T, o10 && (this._$AH = t3);
    else {
      const e8 = t3;
      let n6, r6;
      for (t3 = h3[0], n6 = 0; n6 < h3.length - 1; n6++) r6 = S2(this, e8[s5 + n6], i7, n6), r6 === T && (r6 = this._$AH[n6]), o10 ||= !c3(r6) || r6 !== this._$AH[n6], r6 === E ? t3 = E : t3 !== E && (t3 += (r6 ?? "") + h3[n6 + 1]), this._$AH[n6] = r6;
    }
    o10 && !e7 && this.j(t3);
  }
  j(t3) {
...
var L = class extends k {
  constructor(t3, i7, s5, e7, h3) {
    super(t3, i7, s5, e7, h3), this.type = 5;
  }
  _$AI(t3, i7 = this) {
    if ((t3 = S2(this, t3, i7, 0) ?? E) === T) return;
    const s5 = this._$AH, e7 = t3 === E && s5 !== E || t3.capture !== s5.capture || t3.once !== s5.once || t3.passive !== s5.passive, h3 = t3 !== E && (s5 === E || e7);
    e7 && this.element.removeEventListener(this.name, this, s5), h3 && this.element.addEventListener(this.name, this, t3), this._$AH = t3;
  }
  handleEvent(t3) {
...
var z = class {
  constructor(t3, i7, s5) {
    this.element = t3, this.type = 6, this._$AN = void 0, this._$AM = i7, this.options = s5;
  }
  get _$AU() {
    return this._$AM._$AU;
  }
...
var B = (t3, i7, s5) => {
  ...
  if (void 0 === h3) {
    ...
    e7._$litPart$ = h3 = new R(i7.insertBefore(l2(), t4), t4, void 0, s5 ?? {});
  }
...
var r4 = (t3 = o5, e7, r6) => {
  ...
  if (void 0 === s5 && globalThis.litPropertyMetadata.set(i7, s5 = /* @__PURE__ */ new Map()), "setter" === n6 && ((t3 = Object.create(t3)).wrapped = true), s5.set(r6.name, t3), "accessor" === n6) {
    const { name: o10 } = r6;
    return { set(r7) {
      const n7 = e7.get.call(this);
      e7.set.call(this, r7), this.requestUpdate(o10, n7, t3);
    }, init(e8) {
      return void 0 !== e8 && this.C(o10, void 0, t3, e8), e8;
    } };
  }
  if ("setter" === n6) {
    const { name: o10 } = r6;
    return function(r7) {
      const n7 = this[o10];
      e7.call(this, r7), this.requestUpdate(o10, n7, t3);
    };
  }
  throw Error("Unsupported decorator location: " + n6);
};
function n4(t3) {
  return (e7, o10) => "object" == typeof o10 ? r4(t3, e7, o10) : ((t4, e8, o11) => {
    const r6 = e8.hasOwnProperty(o11);
    return e8.constructor.createProperty(o11, t4), r6 ? Object.getOwnPropertyDescriptor(e8, o11) : void 0;
  })(t3, e7, o10);
}

// node_modules/@lit/reactive-element/decorators/base.js
var e4 = (e7, t3, c5) => (c5.configurable = true, c5.enumerable = true, Reflect.decorate && "object" != typeof t3 && Object.defineProperty(e7, t3, c5), c5);

// node_modules/@lit/reactive-element/decorators/query.js
function e5(e7, r6) {
  return (n6, s5, i7) => {
    const o10 = (t3) => t3.renderRoot?.querySelector(e7) ?? null;
    if (r6) {
      ...
      return e4(n6, s5, { get() {
        let t3 = e8.call(this);
        return void 0 === t3 && (t3 = o10(this), (null !== t3 || this.hasUpdated) && r7.call(this, t3)), t3;
      } });
    }
    return e4(n6, s5, { get() {
      return o10(this);
...
var d3 = (n6, t3, r6, i7) => {
  for (var e7 = void 0, s5 = n6.length - 1, o10; s5 >= 0; s5--)
    (o10 = n6[s5]) && (e7 = o10(t3, r6, e7) || e7);
  return e7 && a3(t3, r6, e7), e7;
};
var f3 = class extends i4 {
  ...
  componentClassNames(t3, r6 = {}) {
    return (0, import_classnames.default)(t3, this.styleModifier, r6);
  }
  /**
   ...
   */
  dispatch({ e: t3, eventName: r6, detailObj: i7 = {}, optionsObj: e7 = {} }) {
    const s5 = {
      bubbles: true,
      composed: true,
      ...e7,
      detail: { ...t3 && { originalEvent: t3 }, ...i7 }
    }, o10 = new CustomEvent(r6, s5);
    return this.dispatchEvent(o10), o10;
  }
  /**
...
// node_modules/@brad-frost-web/eddie-web-components/components/DialogController/DialogController.js
function i5() {
  let t3 = document.activeElement;
  for (; t3?.shadowRoot?.activeElement; )
    t3 = t3.shadowRoot.activeElement;
  return t3;
}
var s4 = class {
  constructor(e7, o10) {
    this.wiredDialog = null, this.trigger = null, this.previousBodyOverflow = null, this.options = o10, this.handleCancel = this.handleCancel.bind(this), this.handleKeydown = this.handleKeydown.bind(this), e7.addController(this);
  }
  isModal() {
    return this.options.isModal ? this.options.isModal() : true;
  }
  hostDisconnected() {
    this.unlockScroll(), this.teardownDialog();
  }
  /**
   * Runs after every host render. Wires listeners to the current dialog element
   * and syncs the native open state to the host's desired state.
   */
  hostUpdated() {
    const e7 = this.options.getDialog();
    e7 && (e7 !== this.wiredDialog && (this.teardownDialog(), e7.addEventListener("cancel", this.handleCancel), e7.addEventListener("keydown", this.handleKeydown), this.wiredDialog = e7), this.sync(e7));
  }
  /**
   * Reconcile the native dialog's open state with the host's desired state.
   * Idempotent — acts only on an actual open↔closed transition.
   */
  sync(e7) {
    const o10 = this.options.isOpen();
    o10 && !e7.open ? this.open(e7) : !o10 && e7.open && this.close(e7);
  }
  open(e7) {
    if (this.isModal()) {
      const o10 = i5();
      this.trigger = o10 instanceof HTMLElement ? o10 : null, e7.showModal(), this.lockScroll(), this.moveInitialFocus(e7);
    } else
      e7.show();
  }
  close(e7) {
    e7.close(), this.unlockScroll(), this.restoreFocus();
  }
  moveInitialFocus(e7) {
    requestAnimationFrame(() => {
      (this.options.getInitialFocus?.() ?? e7).focus();
    });
  }
  /**
   * Return focus to the element that opened the dialog. `showModal()` restores
   * focus natively, but `show()` (non-modal) does not, and guarding a trigger
   * that was removed from the DOM is on us either way (Sutton).
   */
  restoreFocus() {
    const e7 = this.trigger;
    this.trigger = null, e7 && e7.isConnected && e7.focus();
  }
  lockScroll() {
    this.previousBodyOverflow === null && (this.previousBodyOverflow = document.body.style.overflow), document.body.style.overflow = "hidden";
  }
  unlockScroll() {
    this.previousBodyOverflow !== null && (document.body.style.overflow = this.previousBodyOverflow, this.previousBodyOverflow = null);
  }
  teardownDialog() {
    this.wiredDialog && (this.wiredDialog.removeEventListener("cancel", this.handleCancel), this.wiredDialog.removeEventListener("keydown", this.handleKeydown), this.wiredDialog = null);
  }
  /**
   * Native `cancel` fires when a modal dialog receives a genuine close request
   * (a real Escape keypress). Prevent the default native close so the host's
   * `isActive` stays the single source of truth — flipping it re-enters
   * `sync()`, which performs the actual close.
   */
  handleCancel(e7) {
    e7.preventDefault(), this.options.onRequestClose();
  }
  /**
   * Escape-to-close via keydown, for both modal and non-modal dialogs. Non-modal
   * dialogs never emit `cancel`, and synthetic keypresses (test harnesses) do not
   * trigger the browser's native close request either — so this keydown path is
   * what makes Escape work in those cases. For a real Escape on a modal dialog
   * both this and `handleCancel` fire; `onRequestClose` is idempotent (it just
   * sets the host's open state to false), so double-firing is harmless.
   */
  handleKeydown(e7) {
    e7.key === "Escape" && (e7.preventDefault(), this.options.onRequestClose());
  }
};
...
var n5 = (r6, t3, i7, f6) => {
  for (var e7 = o6(t3, i7), s5 = r6.length - 1, u4; s5 >= 0; s5--)
    (u4 = r6[s5]) && (e7 = u4(t3, i7, e7) || e7);
  return e7 && p3(t3, i7, e7), e7;
};
var l4 = class l5 extends f3 {
  get value() {
  ...
  set value(t3) {
    const i7 = this.value;
    this.internalValue = t3, this.type !== "checkbox" && this.type !== "radio" && this.internals.setFormValue(t3), this.updateField(), this.requestUpdate("value", i7);
  }
  /**
...
var z2 = { CHILD: 2 };
var Z = (r6) => (...t3) => ({ _$litDirective$: r6, values: t3 });
var F = class {
  constructor(t3) {
  }
  get _$AU() {
  ...
  _$AT(t3, e7, s5) {
    this._$Ct = t3, this._$AM = e7, this._$Ci = s5;
  }
  _$AS(t3, e7) {
...
var L2 = T2 ? T2.createPolicy("lit-html", { createHTML: (r6) => r6 }) : void 0;
var W = "$lit$";
...
var H2 = (r6) => r6 === null || typeof r6 != "object" && typeof r6 != "function";
var I2 = Array.isArray;
var G = (r6) => I2(r6) || typeof r6?.[Symbol.iterator] == "function";
var w2 = `[ 	
\f\r]`;
var y3 = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g;
var R2 = /-->/g;
var B2 = />/g;
var p4 = RegExp(`>|${w2}(?:([^\\s"'>=/]+)(${w2}*=${w2}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g");
var D = /'/g;
var O = /"/g;
...
function k2(r6, t3) {
  if (!I2(r6) || !r6.hasOwnProperty("raw")) throw Error("invalid template strings array");
  return L2 !== void 0 ? L2.createHTML(t3) : t3;
}
var J = (r6, t3) => {
  const e7 = r6.length - 1, s5 = [];
  let i7, n6 = t3 === 2 ? "<svg>" : t3 === 3 ? "<math>" : "", o10 = y3;
  for (let A2 = 0; A2 < e7; A2++) {
    const h3 = r6[A2];
    let a5, c5, l6 = -1, _2 = 0;
    for (; _2 < h3.length && (o10.lastIndex = _2, c5 = o10.exec(h3), c5 !== null); ) _2 = o10.lastIndex, o10 === y3 ? c5[1] === "!--" ? o10 = R2 : c5[1] !== void 0 ? o10 = B2 : c5[2] !== void 0 ? (V2.test(c5[2]) && (i7 = RegExp("</" + c5[2], "g")), o10 = p4) : c5[3] !== void 0 && (o10 = p4) : o10 === p4 ? c5[0] === ">" ? (o10 = i7 ?? y3, l6 = -1) : c5[1] === void 0 ? l6 = -2 : (l6 = o10.lastIndex - c5[2].length, a5 = c5[1], o10 = c5[3] === void 0 ? p4 : c5[3] === '"' ? O : D) : o10 === O || o10 === D ? o10 = p4 : o10 === R2 || o10 === B2 ? o10 = y3 : (o10 = p4, i7 = void 0);
    const d5 = o10 === p4 && r6[A2 + 1].startsWith("/>") ? " " : "";
    n6 += o10 === y3 ? h3 + q : l6 >= 0 ? (s5.push(a5), h3.slice(0, l6) + W + h3.slice(l6) + u3 + d5) : h3 + u3 + (l6 === -2 ? A2 : d5);
  }
  return [k2(r6, n6 + (r6[e7] || "<?>") + (t3 === 2 ? "</svg>" : t3 === 3 ? "</math>" : "")), s5];
};
var x2 = class _x {
  constructor({ strings: t3, _$litType$: e7 }, s5) {
    let i7;
    this.parts = [];
    let n6 = 0, o10 = 0;
    const A2 = t3.length - 1, h3 = this.parts, [a5, c5] = J(t3, e7);
    if (this.el = _x.createElement(a5, s5), g2.currentNode = this.el.content, e7 === 2 || e7 === 3) {
      const l6 = this.el.content.firstChild;
      l6.replaceWith(...l6.childNodes);
    }
    for (; (i7 = g2.nextNode()) !== null && h3.length < A2; ) {
      if (i7.nodeType === 1) {
        if (i7.hasAttributes()) for (const l6 of i7.getAttributeNames()) if (l6.endsWith(W)) {
          const _2 = c5[o10++], d5 = i7.getAttribute(l6).split(u3), N2 = /([.?@])?(.*)/.exec(_2);
          h3.push({ type: 1, index: n6, name: N2[2], strings: d5, ctor: N2[1] === "." ? Q : N2[1] === "?" ? X : N2[1] === "@" ? Y : M2 }), i7.removeAttribute(l6);
        } else l6.startsWith(u3) && (h3.push({ type: 6, index: n6 }), i7.removeAttribute(l6));
        if (V2.test(i7.tagName)) {
          const l6 = i7.textContent.split(u3), _2 = l6.length - 1;
          if (_2 > 0) {
            i7.textContent = T2 ? T2.emptyScript : "";
            for (let d5 = 0; d5 < _2; d5++) i7.append(l6[d5], b3()), g2.nextNode(), h3.push({ type: 2, index: ++n6 });
            i7.append(l6[_2], b3());
          }
        }
      } else if (i7.nodeType === 8) if (i7.data === j2) h3.push({ type: 2, index: n6 });
      else {
        let l6 = -1;
        for (; (l6 = i7.data.indexOf(u3, l6 + 1)) !== -1; ) h3.push({ type: 7, index: n6 }), l6 += u3.length - 1;
      }
      n6++;
    }
  }
  static createElement(t3, e7) {
    const s5 = f4.createElement("template");
    return s5.innerHTML = t3, s5;
  }
};
function m2(r6, t3, e7 = r6, s5) {
  if (t3 === v2) return t3;
  let i7 = s5 !== void 0 ? e7._$Co?.[s5] : e7._$Cl;
  const n6 = H2(t3) ? void 0 : t3._$litDirective$;
  return i7?.constructor !== n6 && (i7?._$AO?.(false), n6 === void 0 ? i7 = void 0 : (i7 = new n6(r6), i7._$AT(r6, e7, s5)), s5 !== void 0 ? (e7._$Co ??= [])[s5] = i7 : e7._$Cl = i7), i7 !== void 0 && (t3 = m2(r6, i7._$AS(r6, t3.values), i7, s5)), t3;
}
var K = class {
  constructor(t3, e7) {
    this._$AV = [], this._$AN = void 0, this._$AD = t3, this._$AM = e7;
  }
  get parentNode() {
    return this._$AM.parentNode;
  }
  ...
  u(t3) {
    const { el: { content: e7 }, parts: s5 } = this._$AD, i7 = (t3?.creationScope ?? f4).importNode(e7, true);
    g2.currentNode = i7;
    let n6 = g2.nextNode(), o10 = 0, A2 = 0, h3 = s5[0];
    for (; h3 !== void 0; ) {
      if (o10 === h3.index) {
        let a5;
        h3.type === 2 ? a5 = new C2(n6, n6.nextSibling, this, t3) : h3.type === 1 ? a5 = new h3.ctor(n6, h3.name, h3.strings, this, t3) : h3.type === 6 && (a5 = new tt(n6, this, t3)), this._$AV.push(a5), h3 = s5[++A2];
      }
      o10 !== h3?.index && (n6 = g2.nextNode(), o10++);
    }
    return g2.currentNode = f4, i7;
  }
  p(t3) {
    let e7 = 0;
    for (const s5 of this._$AV) s5 !== void 0 && (s5.strings !== void 0 ? (s5._$AI(t3, s5, e7), e7 += s5.strings.length - 2) : s5._$AI(t3[e7])), e7++;
  }
};
var C2 = class _C {
  get _$AU() {
  ...
  constructor(t3, e7, s5, i7) {
    this.type = 2, this._$AH = $2, this._$AN = void 0, this._$AA = t3, this._$AB = e7, this._$AM = s5, this.options = i7, this._$Cv = i7?.isConnected ?? true;
  }
  get parentNode() {
    let t3 = this._$AA.parentNode;
    const e7 = this._$AM;
    return e7 !== void 0 && t3?.nodeType === 11 && (t3 = e7.parentNode), t3;
  }
  get startNode() {
    return this._$AA;
  }
  ...
  _$AI(t3, e7 = this) {
    t3 = m2(this, t3, e7), H2(t3) ? t3 === $2 || t3 == null || t3 === "" ? (this._$AH !== $2 && this._$AR(), this._$AH = $2) : t3 !== this._$AH && t3 !== v2 && this._(t3) : t3._$litType$ !== void 0 ? this.$(t3) : t3.nodeType !== void 0 ? this.T(t3) : G(t3) ? this.k(t3) : this._(t3);
  }
  O(t3) {
    return this._$AA.parentNode.insertBefore(t3, this._$AB);
  }
  ...
  _(t3) {
    this._$AH !== $2 && H2(this._$AH) ? this._$AA.nextSibling.data = t3 : this.T(f4.createTextNode(t3)), this._$AH = t3;
  }
  $(t3) {
    const { values: e7, _$litType$: s5 } = t3, i7 = typeof s5 == "number" ? this._$AC(t3) : (s5.el === void 0 && (s5.el = x2.createElement(k2(s5.h, s5.h[0]), this.options)), s5);
    if (this._$AH?._$AD === i7) this._$AH.p(e7);
    else {
      const n6 = new K(i7, this), o10 = n6.u(this.options);
      n6.p(e7), this.T(o10), this._$AH = n6;
    }
  }
  _$AC(t3) {
    let e7 = P2.get(t3.strings);
    return e7 === void 0 && P2.set(t3.strings, e7 = new x2(t3)), e7;
  }
  k(t3) {
    I2(this._$AH) || (this._$AH = [], this._$AR());
    const e7 = this._$AH;
    let s5, i7 = 0;
    for (const n6 of t3) i7 === e7.length ? e7.push(s5 = new _C(this.O(b3()), this.O(b3()), this, this.options)) : s5 = e7[i7], s5._$AI(n6), i7++;
    i7 < e7.length && (this._$AR(s5 && s5._$AB.nextSibling, i7), e7.length = i7);
  }
  _$AR(t3 = this._$AA.nextSibling, e7) {
    for (this._$AP?.(false, true, e7); t3 !== this._$AB; ) {
      const s5 = U(t3).nextSibling;
      U(t3).remove(), t3 = s5;
    }
  }
  setConnected(t3) {
...
var M2 = class {
  ...
  constructor(t3, e7, s5, i7, n6) {
    this.type = 1, this._$AH = $2, this._$AN = void 0, this.element = t3, this.name = e7, this._$AM = i7, this.options = n6, s5.length > 2 || s5[0] !== "" || s5[1] !== "" ? (this._$AH = Array(s5.length - 1).fill(new String()), this.strings = s5) : this._$AH = $2;
  }
  _$AI(t3, e7 = this, s5, i7) {
    const n6 = this.strings;
    let o10 = false;
    if (n6 === void 0) t3 = m2(this, t3, e7, 0), o10 = !H2(t3) || t3 !== this._$AH && t3 !== v2, o10 && (this._$AH = t3);
    else {
      const A2 = t3;
      let h3, a5;
      for (t3 = n6[0], h3 = 0; h3 < n6.length - 1; h3++) a5 = m2(this, A2[s5 + h3], e7, h3), a5 === v2 && (a5 = this._$AH[h3]), o10 ||= !H2(a5) || a5 !== this._$AH[h3], a5 === $2 ? t3 = $2 : t3 !== $2 && (t3 += (a5 ?? "") + n6[h3 + 1]), this._$AH[h3] = a5;
    }
    o10 && !i7 && this.j(t3);
  }
  j(t3) {
    t3 === $2 ? this.element.removeAttribute(this.name) : this.element.setAttribute(this.name, t3 ?? "");
  }
};
var Q = class extends M2 {
  ...
  j(t3) {
    this.element[this.name] = t3 === $2 ? void 0 : t3;
  }
};
var X = class extends M2 {
  ...
  j(t3) {
    this.element.toggleAttribute(this.name, !!t3 && t3 !== $2);
  }
};
var Y = class extends M2 {
  constructor(t3, e7, s5, i7, n6) {
    super(t3, e7, s5, i7, n6), this.type = 5;
  }
  _$AI(t3, e7 = this) {
    if ((t3 = m2(this, t3, e7, 0) ?? $2) === v2) return;
    const s5 = this._$AH, i7 = t3 === $2 && s5 !== $2 || t3.capture !== s5.capture || t3.once !== s5.once || t3.passive !== s5.passive, n6 = t3 !== $2 && (s5 === $2 || i7);
    i7 && this.element.removeEventListener(this.name, this, s5), n6 && this.element.addEventListener(this.name, this, t3), this._$AH = t3;
  }
  handleEvent(t3) {
...
var tt = class {
  constructor(t3, e7, s5) {
    this.element = t3, this.type = 6, this._$AN = void 0, this._$AM = e7, this.options = s5;
  }
  get _$AU() {
    return this._$AM._$AU;
  }
...
var E2 = class extends F {
  constructor(t3) {
    if (super(t3), this.it = $2, t3.type !== z2.CHILD) throw Error(this.constructor.directiveName + "() can only be used in child bindings");
  }
  render(t3) {
    if (t3 === $2 || t3 == null) return this._t = void 0, this.it = t3;
    if (t3 === v2) return t3;
    if (typeof t3 != "string") throw Error(this.constructor.directiveName + "() called with a non-string value");
...
var V3 = Z(d4);
var H3 = '@charset "UTF-8";:root,:host{--size-base-unit: .5rem}*,::slotted(*),*:before,*:after{box-sizing:border-box}h1,h2,h3,h4,h5,h6{margin:0}.ed-c-icon{display:inline-block;vertical-align:-.125em;fill:var(--ed-icon-fill, currentColor);height:var(--ed-icon-height, 1rem );width:var(--ed-icon-width, 1rem )}';
...
var c4 = (l6, e7, i7, w3) => {
  for (var o10 = void 0, h3 = l6.length - 1, s5; h3 >= 0; h3--)
    (s5 = l6[h3]) && (o10 = s5(e7, i7, o10) || o10);
  return o10 && v3(e7, i7, o10), o10;
};
var C3 = class extends f3 {
  ...
  render() {
    const e7 = this.componentClassNames("ed-c-icon", {
      "ed-c-icon--knockout": this.knockout === true || this.inverted === true
    });
    if (!this._useSpriteMode && this.name) {
      const i7 = r5.get(this.name);
      if (i7)
        return x`
          <svg
...
var b4 = class b5 extends a4 {
  ...
  formSubmit() {
    const t3 = this.internals.form;
    if (t3) {
      const n6 = new Event("submit", {
        bubbles: true,
        cancelable: true
      });
      t3.dispatchEvent(n6), t3.submit();
    }
  }
  formReset() {
    const t3 = this.internals.form;
  ...
  getSpinnerElement() {
    return this.isLoading ? x`<ed-icon class="ed-c-button__spinner" aria-hidden="true" name="spinner"></ed-icon>` : E;
  }
  createButton(t3) {
    const n6 = this.getIconElement(), i7 = this.getSpinnerElement();
    return x`
      <button type="${this.type}" class="${t3}" ?disabled=${this.disabled || this.isLoading}
        aria-busy=${this.isLoading ? "true" : E} @click=${this.clickHandler}>
        ${this.isLoading ? i7 : this.iconPosition === "before" ? n6 : E}
        <span class="${this.hideText ? "ed-u-is-vishidden ed-c-button__text" : "ed-c-button__text"}"><slot>${this.text}</slot></span>
        ${!this.isLoading && this.iconPosition === "after" ? n6 : E}
      </button>
    `;
  }
  createAnchorButton(t3) {
    const n6 = this.getIconElement(), i7 = this.getSpinnerElement();
    return x`
      <a href="${o7(this.href)}" class="${t3}" target=${this.target}
        aria-busy=${this.isLoading ? "true" : E} aria-disabled=${this.isLoading ? "true" : E} @click=${this.clickHandler}>
        ${this.isLoading ? i7 : this.iconPosition === "before" ? n6 : E}
        <span class="${this.hideText ? "ed-u-is-vishidden ed-c-button__text" : "ed-c-button__text"}"><slot>${this.text}</slot></span>
        ${!this.isLoading && this.iconPosition === "after" ? n6 : E}
      </a>
  ...
  render() {
    const t3 = this.componentClassNames("ed-c-button", {
      "ed-c-button--primary": this.variant === "primary",
      "ed-c-button--danger": this.variant === "danger",
      "ed-c-button--bare": this.variant === "bare",
      "ed-c-button--link": this.variant === "link",
      "ed-c-button--knockout": this.knockout === true || this.inverted === true,
      "ed-c-button--loading": this.isLoading === true,
      "ed-c-button--full-width": this.fullWidth === true,
      "ed-c-button--sm": this.size === "sm",
      "ed-c-button--lg": this.size === "lg"
    });
    return this.href ? this.createAnchorButton(t3) : this.createButton(t3);
  }
};
b4.formAssociated = true;
var e6 = b4;
o8([
  n4()
], e6.prototype, "text");
...
// node_modules/@brad-frost-web/eddie-web-components/components/modal/modal.js
var f5 = '@charset "UTF-8";:root,:host{--size-base-unit: .5rem}*,::slotted(*),*:before,*:after{box-sizing:border-box}h1,h2,h3,h4,h5,h6{margin:0}.ed-c-modal{inline-size:100%;block-size:100%;max-inline-size:100%;max-block-size:100%;padding:0;border:none;overflow:hidden;color:inherit;background:var(--ed-theme-color-background-default);box-shadow:var(--ed-theme-box-shadow-sm);opacity:0;transition:opacity var(--ed-theme-animation-fade-quick) var(--ed-theme-animation-ease),overlay var(--ed-theme-animation-fade-quick) var(--ed-theme-animation-ease) allow-discrete,display var(--ed-theme-animation-fade-quick) var(--ed-theme-animation-ease) allow-discrete}.ed-c-modal:focus-visible{outline:var(--ed-theme-border-width-lg) solid var(--ed-theme-focus-ring-color-border-default);outline-offset:var(--ed-theme-offset-focus-ring, .25rem )}.ed-c-modal[open]{opacity:1}@starting-style{.ed-c-modal[open]{opacity:0}}.ed-c-modal::backdrop{background:var(--ed-theme-color-background-transparent)}@media all and (min-width:47rem){.ed-c-modal{inline-size:48rem;max-inline-size:90%;block-size:fit-content;max-block-size:90vh}}.ed-c-modal--full-width{inline-size:100%;max-inline-size:none;block-size:100vh;max-block-size:none}@media all and (min-width:47rem){.ed-c-modal--full-width{inline-size:100%;max-inline-size:none;block-size:100vh;max-block-size:none}}.ed-c-modal__window{display:flex;flex-direction:column;block-size:100%;overflow:auto}@media all and (min-width:47rem){.ed-c-modal__window{max-block-size:90vh}}.ed-c-modal--full-width .ed-c-modal__window{max-block-size:none}.ed-c-modal__close-button{padding:1.5rem;position:absolute;inset-block-start:0;inset-inline-end:0}.ed-c-modal__header,.ed-c-modal__body,.ed-c-modal__footer{padding:1.5rem}.ed-c-modal__header{display:flex;justify-content:space-between;align-items:center}';
var p5 = Object.defineProperty;
var i6 = (d5, t3, n6, b6) => {
  for (var e7 = void 0, l6 = d5.length - 1, s5; l6 >= 0; l6--)
    (s5 = d5[l6]) && (e7 = s5(t3, n6, e7) || e7);
  return e7 && p5(t3, n6, e7), e7;
};
var o9 = class extends f3 {
  static get styles() {
    return r(f5);
  }
  constructor() {
    super(), new s4(this, {
      getDialog: () => this.dialogElement,
   ...
   */
  closeModal() {
    this.isActive = false, this.closeFunction && this.closeFunction();
  }
  render() {
    const t3 = this.componentClassNames("ed-c-modal", {
      "ed-c-modal--full-width": this.fullWidth === true,
      "ed-is-active": this.isActive === true
    });
    return x`
      <dialog class="${t3}" tabindex="-1" aria-modal="true" aria-label="${this.dialogLabel || "Dialog"}">
        <div class="ed-c-modal__window">
          <ed-button
          ...
          ${this.slotNotEmpty("footer") && x`<div class="ed-c-modal__footer">
...
i6([
  n4({ type: Boolean })
], o9.prototype, "fullWidth");
i6([
  n4({ type: Boolean })
], o9.prototype, "isActive");
i6([
  n4()
], o9.prototype, "dialogLabel");
i6([
  n4()
], o9.prototype, "closeFunction");
i6([
  e5(".ed-c-modal")
], o9.prototype, "dialogElement");
customElements.get("ed-modal") === void 0 && customElements.define("ed-modal", o9);
