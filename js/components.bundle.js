...
var n = class {
  ...
  get styleSheet() {
    ...
    if (e && void 0 === t4) {
      ...
      e8 && (t4 = o.get(s6)), void 0 === t4 && ((this.o = t4 = new CSSStyleSheet()).replaceSync(this.cssText), e8 && o.set(s6, t4));
    }
    return t4;
  }
  toString() {
...
var S = (s6, o13) => {
  if (e) s6.adoptedStyleSheets = o13.map((t4) => t4 instanceof CSSStyleSheet ? t4 : t4.styleSheet);
  else for (const e8 of o13) {
    const o14 = document.createElement("style"), n8 = t.litNonce;
    void 0 !== n8 && o14.setAttribute("nonce", n8), o14.textContent = e8.cssText, s6.appendChild(o14);
  }
};
var c = e ? (t4) => t4 : (t4) => t4 instanceof CSSStyleSheet ? ((t5) => {
  let e8 = "";
  for (const s6 of t5.cssRules) e8 += s6.cssText;
  return r(e8);
})(t4) : t4;
...
var y = class extends HTMLElement {
  ...
  static getPropertyDescriptor(t4, s6, i11) {
    ...
    return { get: e8, set(s7) {
      ...
      r8?.call(this, s7), this.requestUpdate(t4, h6, i11);
  ...
  static finalizeStyles(s6) {
    ...
    if (Array.isArray(s6)) {
      ...
      for (const s7 of e8) i11.unshift(c(s7));
  ...
  _$ET(t4, s6) {
    const i11 = this.constructor.elementProperties.get(t4), e8 = this.constructor._$Eu(t4, i11);
    if (void 0 !== e8 && true === i11.reflect) {
  ...
  _$AK(t4, s6) {
    const i11 = this.constructor, e8 = i11._$Eh.get(t4);
    if (void 0 !== e8 && this._$Em !== e8) {
      const t5 = i11.getPropertyOptions(e8), h6 = "function" == typeof t5.converter ? { fromAttribute: t5.converter } : void 0 !== t5.converter?.fromAttribute ? t5.converter : u;
      this._$Em = e8;
      const r8 = h6.fromAttribute(s6, t5.type);
  ...
  requestUpdate(t4, s6, i11) {
    if (void 0 !== t4) {
      ...
      if (i11 ??= e8.getPropertyOptions(t4), !((i11.hasChanged ?? f)(h6, s6) || i11.useDefault && i11.reflect && h6 === this._$Ej?.get(t4) && !this.hasAttribute(e8._$Eu(t4, i11)))) return;
      this.C(t4, s6, i11);
    }
    false === this.isUpdatePending && (this._$ES = this._$EP());
  }
  C(t4, s6, { useDefault: i11, reflect: e8, wrapped: h6 }, r8) {
    i11 && !(this._$Ej ??= /* @__PURE__ */ new Map()).has(t4) && (this._$Ej.set(t4, r8 ?? s6 ?? this[t4]), true !== h6 || void 0 !== r8) || (this._$AL.has(t4) || (this.hasUpdated || i11 || (s6 = void 0), this._$AL.set(t4, s6)), true === e8 && this._$Em !== t4 && (this._$Eq ??= /* @__PURE__ */ new Set()).add(t4));
  }
  async _$EP() {
  ...
  performUpdate() {
    ...
    if (!this.hasUpdated) {
      ...
      if (t5.size > 0) for (const [s7, i11] of t5) {
        const { wrapped: t6 } = i11, e8 = this[s7];
        true !== t6 || this._$AL.has(s7) || void 0 === e8 || this.C(s7, void 0, i11, e8);
      }
    }
    let t4 = false;
    const s6 = this._$AL;
...
var V = (t4, i11) => {
  const s6 = t4.length - 1, o13 = [];
  let r8, l8 = 2 === i11 ? "<svg>" : 3 === i11 ? "<math>" : "", c7 = f2;
  for (let i12 = 0; i12 < s6; i12++) {
    const s7 = t4[i12];
    let a6, u5, d6 = -1, y6 = 0;
    for (; y6 < s7.length && (c7.lastIndex = y6, u5 = c7.exec(s7), null !== u5); ) y6 = c7.lastIndex, c7 === f2 ? "!--" === u5[1] ? c7 = v : void 0 !== u5[1] ? c7 = _ : void 0 !== u5[2] ? ($.test(u5[2]) && (r8 = RegExp("</" + u5[2], "g")), c7 = m) : void 0 !== u5[3] && (c7 = m) : c7 === m ? ">" === u5[0] ? (c7 = r8 ?? f2, d6 = -1) : void 0 === u5[1] ? d6 = -2 : (d6 = c7.lastIndex - u5[2].length, a6 = u5[1], c7 = void 0 === u5[3] ? m : '"' === u5[3] ? g : p2) : c7 === g || c7 === p2 ? c7 = m : c7 === v || c7 === _ ? c7 = f2 : (c7 = m, r8 = void 0);
    const x3 = c7 === m && t4[i12 + 1].startsWith("/>") ? " " : "";
    l8 += c7 === f2 ? s7 + n3 : d6 >= 0 ? (o13.push(a6), s7.slice(0, d6) + e3 + s7.slice(d6) + h2 + x3) : s7 + h2 + (-2 === d6 ? i12 : x3);
  }
  return [P(t4, l8 + (t4[s6] || "<?>") + (2 === i11 ? "</svg>" : 3 === i11 ? "</math>" : "")), o13];
};
var N = class _N {
  constructor({ strings: t4, _$litType$: s6 }, n8) {
    ...
    this.parts = [];
    let c7 = 0, a6 = 0;
    const u5 = t4.length - 1, d6 = this.parts, [f6, v5] = V(t4, s6);
    if (this.el = _N.createElement(f6, n8), C.currentNode = this.el.content, 2 === s6 || 3 === s6) {
      const t5 = this.el.content.firstChild;
      t5.replaceWith(...t5.childNodes);
    }
    for (; null !== (r8 = C.nextNode()) && d6.length < u5; ) {
      if (1 === r8.nodeType) {
        if (r8.hasAttributes()) for (const t5 of r8.getAttributeNames()) if (t5.endsWith(e3)) {
          const i11 = v5[a6++], s7 = r8.getAttribute(t5).split(h2), e8 = /([.?@])?(.*)/.exec(i11);
          d6.push({ type: 1, index: c7, name: e8[2], strings: s7, ctor: "." === e8[1] ? H : "?" === e8[1] ? I : "@" === e8[1] ? L : k }), r8.removeAttribute(t5);
        } else t5.startsWith(h2) && (d6.push({ type: 6, index: c7 }), r8.removeAttribute(t5));
        if ($.test(r8.tagName)) {
          const t5 = r8.textContent.split(h2), s7 = t5.length - 1;
          if (s7 > 0) {
            r8.textContent = i3 ? i3.emptyScript : "";
            for (let i11 = 0; i11 < s7; i11++) r8.append(t5[i11], l2()), C.nextNode(), d6.push({ type: 2, index: ++c7 });
            r8.append(t5[s7], l2());
          }
        }
      } else if (8 === r8.nodeType) if (r8.data === o3) d6.push({ type: 2, index: c7 });
      else {
        let t5 = -1;
        for (; -1 !== (t5 = r8.data.indexOf(h2, t5 + 1)); ) d6.push({ type: 7, index: c7 }), t5 += h2.length - 1;
      }
      c7++;
    }
  }
...
function S2(t4, i11, s6 = t4, e8) {
  if (i11 === T) return i11;
  let h6 = void 0 !== e8 ? s6._$Co?.[e8] : s6._$Cl;
  const o13 = c3(i11) ? void 0 : i11._$litDirective$;
  return h6?.constructor !== o13 && (h6?._$AO?.(false), void 0 === o13 ? h6 = void 0 : (h6 = new o13(t4), h6._$AT(t4, s6, e8)), void 0 !== e8 ? (s6._$Co ??= [])[e8] = h6 : s6._$Cl = h6), void 0 !== h6 && (i11 = S2(t4, h6._$AS(t4, i11.values), h6, e8)), i11;
}
var M = class {
  constructor(t4, i11) {
  ...
  u(t4) {
    const { el: { content: i11 }, parts: s6 } = this._$AD, e8 = (t4?.creationScope ?? r3).importNode(i11, true);
    C.currentNode = e8;
    let h6 = C.nextNode(), o13 = 0, n8 = 0, l8 = s6[0];
    for (; void 0 !== l8; ) {
      if (o13 === l8.index) {
        let i12;
...
var R = class _R {
  ...
  constructor(t4, i11, s6, e8) {
    this.type = 2, this._$AH = E, this._$AN = void 0, this._$AA = t4, this._$AB = i11, this._$AM = s6, this.options = e8, this._$Cv = e8?.isConnected ?? true;
  }
  get parentNode() {
  ...
  $(t4) {
    const { values: i11, _$litType$: s6 } = t4, e8 = "number" == typeof s6 ? this._$AC(t4) : (void 0 === s6.el && (s6.el = N.createElement(P(s6.h, s6.h[0]), this.options)), s6);
    if (this._$AH?._$AD === e8) this._$AH.p(i11);
    else {
      const t5 = new M(e8, this), s7 = t5.u(this.options);
  ...
  k(t4) {
    ...
    const i11 = this._$AH;
    let s6, e8 = 0;
    for (const h6 of t4) e8 === i11.length ? i11.push(s6 = new _R(this.O(l2()), this.O(l2()), this, this.options)) : s6 = i11[e8], s6._$AI(h6), e8++;
    e8 < i11.length && (this._$AR(s6 && s6._$AB.nextSibling, e8), i11.length = e8);
  }
...
var k = class {
  ...
  constructor(t4, i11, s6, e8, h6) {
    this.type = 1, this._$AH = E, this._$AN = void 0, this.element = t4, this.name = i11, this._$AM = e8, this.options = h6, s6.length > 2 || "" !== s6[0] || "" !== s6[1] ? (this._$AH = Array(s6.length - 1).fill(new String()), this.strings = s6) : this._$AH = E;
  }
  _$AI(t4, i11 = this, s6, e8) {
    const h6 = this.strings;
    let o13 = false;
    if (void 0 === h6) t4 = S2(this, t4, i11, 0), o13 = !c3(t4) || t4 !== this._$AH && t4 !== T, o13 && (this._$AH = t4);
    else {
      const e9 = t4;
      let n8, r8;
      for (t4 = h6[0], n8 = 0; n8 < h6.length - 1; n8++) r8 = S2(this, e9[s6 + n8], i11, n8), r8 === T && (r8 = this._$AH[n8]), o13 ||= !c3(r8) || r8 !== this._$AH[n8], r8 === E ? t4 = E : t4 !== E && (t4 += (r8 ?? "") + h6[n8 + 1]), this._$AH[n8] = r8;
    }
    o13 && !e8 && this.j(t4);
  }
  j(t4) {
...
var L = class extends k {
  constructor(t4, i11, s6, e8, h6) {
    super(t4, i11, s6, e8, h6), this.type = 5;
  }
  _$AI(t4, i11 = this) {
    if ((t4 = S2(this, t4, i11, 0) ?? E) === T) return;
    const s6 = this._$AH, e8 = t4 === E && s6 !== E || t4.capture !== s6.capture || t4.once !== s6.once || t4.passive !== s6.passive, h6 = t4 !== E && (s6 === E || e8);
    e8 && this.element.removeEventListener(this.name, this, s6), h6 && this.element.addEventListener(this.name, this, t4), this._$AH = t4;
  }
  handleEvent(t4) {
...
var B = (t4, i11, s6) => {
  const e8 = s6?.renderBefore ?? i11;
  let h6 = e8._$litPart$;
  if (void 0 === h6) {
    const t5 = s6?.renderBefore ?? null;
    e8._$litPart$ = h6 = new R(i11.insertBefore(l2(), t5), t5, void 0, s6 ?? {});
  }
...
var r4 = (t4 = o5, e8, r8) => {
  const { kind: n8, metadata: i11 } = r8;
  let s6 = globalThis.litPropertyMetadata.get(i11);
  if (void 0 === s6 && globalThis.litPropertyMetadata.set(i11, s6 = /* @__PURE__ */ new Map()), "setter" === n8 && ((t4 = Object.create(t4)).wrapped = true), s6.set(r8.name, t4), "accessor" === n8) {
    const { name: o13 } = r8;
    return { set(r9) {
      const n9 = e8.get.call(this);
      e8.set.call(this, r9), this.requestUpdate(o13, n9, t4);
    }, init(e9) {
  ...
  if ("setter" === n8) {
    ...
    return function(r9) {
      const n9 = this[o13];
      e8.call(this, r9), this.requestUpdate(o13, n9, t4);
    };
  }
...
function e5(e8, r8) {
  return (n8, s6, i11) => {
    ...
    if (r8) {
      const { get: e9, set: r9 } = "object" == typeof s6 ? n8 : i11 ?? (() => {
        const t4 = Symbol();
        return { get() {
          return this[t4];
        }, set(e10) {
...
var d3 = (n8, t4, r8, l8) => {
  for (var e8 = void 0, s6 = n8.length - 1, o13; s6 >= 0; s6--)
    (o13 = n8[s6]) && (e8 = o13(t4, r8, e8) || e8);
...
var t3 = (a6, e8, i11, h6) => {
  for (var d6 = void 0, o13 = a6.length - 1, c7; o13 >= 0; o13--)
    (c7 = a6[o13]) && (d6 = c7(e8, i11, d6) || d6);
  return d6 && p3(e8, i11, d6), d6;
};
...
var n6 = (r8, t4, i11, f6) => {
  for (var e8 = o6(t4, i11), s6 = r8.length - 1, u5; s6 >= 0; s6--)
    (u5 = r8[s6]) && (e8 = u5(t4, i11, e8) || e8);
  return e8 && p4(t4, i11, e8), e8;
};
...
var F = class {
  ...
  _$AT(t4, e8, s6) {
    this._$Ct = t4, this._$AM = e8, this._$Ci = s6;
  }
  _$AS(t4, e8) {
...
var J = (r8, t4) => {
  const e8 = r8.length - 1, s6 = [];
  let i11, n8 = t4 === 2 ? "<svg>" : t4 === 3 ? "<math>" : "", o13 = y3;
  for (let A2 = 0; A2 < e8; A2++) {
    const h6 = r8[A2];
    let a6, c7, l8 = -1, _3 = 0;
    for (; _3 < h6.length && (o13.lastIndex = _3, c7 = o13.exec(h6), c7 !== null); ) _3 = o13.lastIndex, o13 === y3 ? c7[1] === "!--" ? o13 = R2 : c7[1] !== void 0 ? o13 = B2 : c7[2] !== void 0 ? (V2.test(c7[2]) && (i11 = RegExp("</" + c7[2], "g")), o13 = p5) : c7[3] !== void 0 && (o13 = p5) : o13 === p5 ? c7[0] === ">" ? (o13 = i11 ?? y3, l8 = -1) : c7[1] === void 0 ? l8 = -2 : (l8 = o13.lastIndex - c7[2].length, a6 = c7[1], o13 = c7[3] === void 0 ? p5 : c7[3] === '"' ? O : D) : o13 === O || o13 === D ? o13 = p5 : o13 === R2 || o13 === B2 ? o13 = y3 : (o13 = p5, i11 = void 0);
    const d6 = o13 === p5 && r8[A2 + 1].startsWith("/>") ? " " : "";
    n8 += o13 === y3 ? h6 + q : l8 >= 0 ? (s6.push(a6), h6.slice(0, l8) + W + h6.slice(l8) + u3 + d6) : h6 + u3 + (l8 === -2 ? A2 : d6);
  }
  return [k2(r8, n8 + (r8[e8] || "<?>") + (t4 === 2 ? "</svg>" : t4 === 3 ? "</math>" : "")), s6];
};
var x2 = class _x {
  constructor({ strings: t4, _$litType$: e8 }, s6) {
    let i11;
    this.parts = [];
    let n8 = 0, o13 = 0;
    const A2 = t4.length - 1, h6 = this.parts, [a6, c7] = J(t4, e8);
    if (this.el = _x.createElement(a6, s6), g2.currentNode = this.el.content, e8 === 2 || e8 === 3) {
    ...
    for (; (i11 = g2.nextNode()) !== null && h6.length < A2; ) {
      if (i11.nodeType === 1) {
        if (i11.hasAttributes()) for (const l8 of i11.getAttributeNames()) if (l8.endsWith(W)) {
          const _3 = c7[o13++], d6 = i11.getAttribute(l8).split(u3), N2 = /([.?@])?(.*)/.exec(_3);
          h6.push({ type: 1, index: n8, name: N2[2], strings: d6, ctor: N2[1] === "." ? Q : N2[1] === "?" ? X : N2[1] === "@" ? Y : M2 }), i11.removeAttribute(l8);
        } else l8.startsWith(u3) && (h6.push({ type: 6, index: n8 }), i11.removeAttribute(l8));
        if (V2.test(i11.tagName)) {
          const l8 = i11.textContent.split(u3), _3 = l8.length - 1;
          if (_3 > 0) {
            i11.textContent = T2 ? T2.emptyScript : "";
            for (let d6 = 0; d6 < _3; d6++) i11.append(l8[d6], b3()), g2.nextNode(), h6.push({ type: 2, index: ++n8 });
            i11.append(l8[_3], b3());
          }
        }
...
function m2(r8, t4, e8 = r8, s6) {
  if (t4 === v2) return t4;
  let i11 = s6 !== void 0 ? e8._$Co?.[s6] : e8._$Cl;
  const n8 = H2(t4) ? void 0 : t4._$litDirective$;
  return i11?.constructor !== n8 && (i11?._$AO?.(false), n8 === void 0 ? i11 = void 0 : (i11 = new n8(r8), i11._$AT(r8, e8, s6)), s6 !== void 0 ? (e8._$Co ??= [])[s6] = i11 : e8._$Cl = i11), i11 !== void 0 && (t4 = m2(r8, i11._$AS(r8, t4.values), i11, s6)), t4;
}
var K = class {
  constructor(t4, e8) {
  ...
  u(t4) {
    const { el: { content: e8 }, parts: s6 } = this._$AD, i11 = (t4?.creationScope ?? f4).importNode(e8, true);
    g2.currentNode = i11;
    let n8 = g2.nextNode(), o13 = 0, A2 = 0, h6 = s6[0];
    for (; h6 !== void 0; ) {
      if (o13 === h6.index) {
        let a6;
      ...
      o13 !== h6?.index && (n8 = g2.nextNode(), o13++);
    }
    return g2.currentNode = f4, i11;
  }
  p(t4) {
    let e8 = 0;
    for (const s6 of this._$AV) s6 !== void 0 && (s6.strings !== void 0 ? (s6._$AI(t4, s6, e8), e8 += s6.strings.length - 2) : s6._$AI(t4[e8])), e8++;
  }
};
var C2 = class _C {
  get _$AU() {
  ...
  constructor(t4, e8, s6, i11) {
    this.type = 2, this._$AH = $2, this._$AN = void 0, this._$AA = t4, this._$AB = e8, this._$AM = s6, this.options = i11, this._$Cv = i11?.isConnected ?? true;
  }
  get parentNode() {
    let t4 = this._$AA.parentNode;
    const e8 = this._$AM;
  ...
  $(t4) {
    const { values: e8, _$litType$: s6 } = t4, i11 = typeof s6 == "number" ? this._$AC(t4) : (s6.el === void 0 && (s6.el = x2.createElement(k2(s6.h, s6.h[0]), this.options)), s6);
    if (this._$AH?._$AD === i11) this._$AH.p(e8);
    else {
      const n8 = new K(i11, this), o13 = n8.u(this.options);
      n8.p(e8), this.T(o13), this._$AH = n8;
    }
  }
  _$AC(t4) {
  ...
  k(t4) {
    ...
    const e8 = this._$AH;
    let s6, i11 = 0;
    for (const n8 of t4) i11 === e8.length ? e8.push(s6 = new _C(this.O(b3()), this.O(b3()), this, this.options)) : s6 = e8[i11], s6._$AI(n8), i11++;
    i11 < e8.length && (this._$AR(s6 && s6._$AB.nextSibling, i11), e8.length = i11);
  }
...
var M2 = class {
  ...
  constructor(t4, e8, s6, i11, n8) {
    this.type = 1, this._$AH = $2, this._$AN = void 0, this.element = t4, this.name = e8, this._$AM = i11, this.options = n8, s6.length > 2 || s6[0] !== "" || s6[1] !== "" ? (this._$AH = Array(s6.length - 1).fill(new String()), this.strings = s6) : this._$AH = $2;
  }
  _$AI(t4, e8 = this, s6, i11) {
    const n8 = this.strings;
    let o13 = false;
    if (n8 === void 0) t4 = m2(this, t4, e8, 0), o13 = !H2(t4) || t4 !== this._$AH && t4 !== v2, o13 && (this._$AH = t4);
    else {
      const A2 = t4;
      let h6, a6;
      for (t4 = n8[0], h6 = 0; h6 < n8.length - 1; h6++) a6 = m2(this, A2[s6 + h6], e8, h6), a6 === v2 && (a6 = this._$AH[h6]), o13 ||= !H2(a6) || a6 !== this._$AH[h6], a6 === $2 ? t4 = $2 : t4 !== $2 && (t4 += (a6 ?? "") + n8[h6 + 1]), this._$AH[h6] = a6;
    }
    o13 && !i11 && this.j(t4);
  }
  j(t4) {
...
var Y = class extends M2 {
  constructor(t4, e8, s6, i11, n8) {
    super(t4, e8, s6, i11, n8), this.type = 5;
  }
  _$AI(t4, e8 = this) {
...
var tt = class {
  constructor(t4, e8, s6) {
    this.element = t4, this.type = 6, this._$AN = void 0, this._$AM = e8, this.options = s6;
  }
  get _$AU() {
    return this._$AM._$AU;
  }
...
var o9 = (b6, t4, n8, g5) => {
  for (var d6 = void 0, i11 = b6.length - 1, u5; i11 >= 0; i11--)
    (u5 = b6[i11]) && (d6 = u5(t4, n8, d6) || d6);
  return d6 && y4(t4, n8, d6), d6;
};
...
var b4 = (o13, t4, r8, p10) => {
  for (var e8 = void 0, n8 = o13.length - 1, i11; n8 >= 0; n8--)
    (i11 = o13[n8]) && (e8 = i11(t4, r8, e8) || e8);
...
var m4 = (r8, e8, l8, w3) => {
  for (var d6 = void 0, t4 = r8.length - 1, n8; t4 >= 0; t4--)
    (n8 = r8[t4]) && (d6 = n8(e8, l8, d6) || d6);
  return d6 && p6(e8, l8, d6), d6;
};
...
var d5 = (h6, e8, n8, s6) => {
  for (var t4 = void 0, l8 = h6.length - 1, o13; l8 >= 0; l8--)
    (o13 = h6[l8]) && (t4 = o13(e8, n8, t4) || t4);
  return t4 && m5(e8, n8, t4), t4;
};
...
var h3 = (r8, e8, o13, p10) => {
  for (var t4 = void 0, n8 = r8.length - 1, a6; n8 >= 0; n8--)
    (a6 = r8[n8]) && (t4 = a6(e8, o13, t4) || t4);
  return t4 && u4(e8, o13, t4), t4;
};
...
var p8 = (s6, t4, o13, f6) => {
  for (var e8 = void 0, n8 = s6.length - 1, r8; n8 >= 0; n8--)
    (r8 = s6[n8]) && (e8 = r8(t4, o13, e8) || e8);
...
customElements.get("ed-section") === void 0 && customElements.define("ed-section", i9);
...
var l7 = (i11, e8, t4, f6) => {
  for (var a6 = void 0, o13 = i11.length - 1, n8; o13 >= 0; o13--)
    (n8 = i11[o13]) && (a6 = n8(e8, t4, a6) || a6);
  return a6 && y5(e8, t4, a6), a6;
};
...
var m7 = ":root,:host{--size-base-unit: .5rem}*,::slotted(*),*:before,*:after{box-sizing:border-box}h1,h2,h3,h4,h5,h6{margin:0}:host{display:block;position:absolute;inset-block-start:0;inset-inline-end:0;z-index:1;pointer-events:none}.ed-r-corner-ribbon{display:block;position:relative;inline-size:9.5rem;block-size:9.5rem;overflow:hidden}.ed-r-corner-ribbon__strip{font-family:var(--ed-theme-typography-display-default-font-family);font-size:var(--ed-theme-typography-label-lg-font-size);font-weight:var(--ed-typography-font-weight-400);line-height:var(--ed-theme-typography-label-sm-line-height);letter-spacing:var(--ed-theme-typography-label-sm-letter-spacing);text-transform:var(--ed-typography-text-transform-uppercase);text-align:center;position:absolute;inset-block-start:2.5rem;inset-inline-end:-3.25rem;inline-size:13.75rem;padding-block:.5rem;transform:rotate(45deg);background:var(--ed-theme-color-background-brand);color:var(--ed-theme-color-content-default);box-shadow:var(--ed-theme-box-shadow-sm)}";
var b5 = Object.defineProperty;
var h5 = (r8, t4, n8, c7) => {
  for (var e8 = void 0, o13 = r8.length - 1, s6; o13 >= 0; o13--)
    (s6 = r8[o13]) && (e8 = s6(t4, n8, e8) || e8);
  return e8 && b5(t4, n8, e8), e8;
};
...
customElements.get("ed-r-corner-ribbon") === void 0 && customElements.define("ed-r-corner-ribbon", i10);
...
customElements.get("ed-r-media-promo") === void 0 && customElements.define("ed-r-media-promo", m8);
...
var o12 = (a6, i11, l8, g5) => {
  for (var r8 = void 0, s6 = a6.length - 1, n8; s6 >= 0; s6--)
    (n8 = a6[s6]) && (r8 = n8(i11, l8, r8) || r8);
  return r8 && _2(i11, l8, r8), r8;
};
var e7 = class extends f3 {
  ...
  render() {
    const i11 = this.componentClassNames("ed-r-project-card", {
