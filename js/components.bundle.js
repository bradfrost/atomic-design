...
var S = (s6, o11) => {
  if (e) s6.adoptedStyleSheets = o11.map((t4) => t4 instanceof CSSStyleSheet ? t4 : t4.styleSheet);
  else for (const e7 of o11) {
    const o12 = document.createElement("style"), n8 = t.litNonce;
    void 0 !== n8 && o12.setAttribute("nonce", n8), o12.textContent = e7.cssText, s6.appendChild(o12);
  }
};
...
var V = (t4, i11) => {
  const s6 = t4.length - 1, o11 = [];
  let r9, l6 = 2 === i11 ? "<svg>" : 3 === i11 ? "<math>" : "", c8 = f2;
  for (let i12 = 0; i12 < s6; i12++) {
    const s7 = t4[i12];
    let a6, u5, d7 = -1, y6 = 0;
    for (; y6 < s7.length && (c8.lastIndex = y6, u5 = c8.exec(s7), null !== u5); ) y6 = c8.lastIndex, c8 === f2 ? "!--" === u5[1] ? c8 = v : void 0 !== u5[1] ? c8 = _ : void 0 !== u5[2] ? ($.test(u5[2]) && (r9 = RegExp("</" + u5[2], "g")), c8 = m) : void 0 !== u5[3] && (c8 = m) : c8 === m ? ">" === u5[0] ? (c8 = r9 ?? f2, d7 = -1) : void 0 === u5[1] ? d7 = -2 : (d7 = c8.lastIndex - u5[2].length, a6 = u5[1], c8 = void 0 === u5[3] ? m : '"' === u5[3] ? g : p2) : c8 === g || c8 === p2 ? c8 = m : c8 === v || c8 === _ ? c8 = f2 : (c8 = m, r9 = void 0);
    const x3 = c8 === m && t4[i12 + 1].startsWith("/>") ? " " : "";
    l6 += c8 === f2 ? s7 + n3 : d7 >= 0 ? (o11.push(a6), s7.slice(0, d7) + e3 + s7.slice(d7) + h2 + x3) : s7 + h2 + (-2 === d7 ? i12 : x3);
  }
  return [P(t4, l6 + (t4[s6] || "<?>") + (2 === i11 ? "</svg>" : 3 === i11 ? "</math>" : "")), o11];
};
var N = class _N {
  constructor({ strings: t4, _$litType$: s6 }, n8) {
    ...
    this.parts = [];
    let c8 = 0, a6 = 0;
    const u5 = t4.length - 1, d7 = this.parts, [f7, v4] = V(t4, s6);
    ...
    for (; null !== (r9 = C.nextNode()) && d7.length < u5; ) {
      if (1 === r9.nodeType) {
        if (r9.hasAttributes()) for (const t5 of r9.getAttributeNames()) if (t5.endsWith(e3)) {
          const i11 = v4[a6++], s7 = r9.getAttribute(t5).split(h2), e7 = /([.?@])?(.*)/.exec(i11);
          d7.push({ type: 1, index: c8, name: e7[2], strings: s7, ctor: "." === e7[1] ? H : "?" === e7[1] ? I : "@" === e7[1] ? L : k }), r9.removeAttribute(t5);
        } else t5.startsWith(h2) && (d7.push({ type: 6, index: c8 }), r9.removeAttribute(t5));
        if ($.test(r9.tagName)) {
          const t5 = r9.textContent.split(h2), s7 = t5.length - 1;
          if (s7 > 0) {
            r9.textContent = i3 ? i3.emptyScript : "";
            for (let i11 = 0; i11 < s7; i11++) r9.append(t5[i11], l2()), C.nextNode(), d7.push({ type: 2, index: ++c8 });
            r9.append(t5[s7], l2());
          }
        }
      } else if (8 === r9.nodeType) if (r9.data === o3) d7.push({ type: 2, index: c8 });
      else {
        let t5 = -1;
        for (; -1 !== (t5 = r9.data.indexOf(h2, t5 + 1)); ) d7.push({ type: 7, index: c8 }), t5 += h2.length - 1;
      }
      c8++;
    }
  }
...
function S2(t4, i11, s6 = t4, e7) {
  ...
  return h6?.constructor !== o11 && (h6?._$AO?.(false), void 0 === o11 ? h6 = void 0 : (h6 = new o11(t4), h6._$AT(t4, s6, e7)), void 0 !== e7 ? (s6._$Co ??= [])[e7] = h6 : s6._$Cl = h6), void 0 !== h6 && (i11 = S2(t4, h6._$AS(t4, i11.values), h6, e7)), i11;
}
var M = class {
  constructor(t4, i11) {
  ...
  u(t4) {
    ...
    C.currentNode = e7;
    let h6 = C.nextNode(), o11 = 0, n8 = 0, l6 = s6[0];
    for (; void 0 !== l6; ) {
      if (o11 === l6.index) {
        let i12;
        2 === l6.type ? i12 = new R(h6, h6.nextSibling, this, t4) : 1 === l6.type ? i12 = new l6.ctor(h6, l6.name, l6.strings, this, t4) : 6 === l6.type && (i12 = new z(h6, this, t4)), this._$AV.push(i12), l6 = s6[++n8];
      }
...
var k = class {
  ...
  _$AI(t4, i11 = this, s6, e7) {
    ...
    let o11 = false;
    if (void 0 === h6) t4 = S2(this, t4, i11, 0), o11 = !c3(t4) || t4 !== this._$AH && t4 !== T, o11 && (this._$AH = t4);
    else {
      const e8 = t4;
      let n8, r9;
      for (t4 = h6[0], n8 = 0; n8 < h6.length - 1; n8++) r9 = S2(this, e8[s6 + n8], i11, n8), r9 === T && (r9 = this._$AH[n8]), o11 ||= !c3(r9) || r9 !== this._$AH[n8], r9 === E ? t4 = E : t4 !== E && (t4 += (r9 ?? "") + h6[n8 + 1]), this._$AH[n8] = r9;
    }
    o11 && !e7 && this.j(t4);
  }
  j(t4) {
...
var r4 = (t4 = o5, e7, r9) => {
  ...
  if (void 0 === s6 && globalThis.litPropertyMetadata.set(i11, s6 = /* @__PURE__ */ new Map()), "setter" === n8 && ((t4 = Object.create(t4)).wrapped = true), s6.set(r9.name, t4), "accessor" === n8) {
    ...
    return { set(r10) {
      ...
      e7.set.call(this, r10), this.requestUpdate(o11, n9, t4);
    }, init(e8) {
      return void 0 !== e8 && this.C(o11, void 0, t4, e8), e8;
    } };
  }
  if ("setter" === n8) {
    const { name: o11 } = r9;
    return function(r10) {
      const n9 = this[o11];
      e7.call(this, r10), this.requestUpdate(o11, n9, t4);
    };
  }
  throw Error("Unsupported decorator location: " + n8);
};
function n4(t4) {
  return (e7, o11) => "object" == typeof o11 ? r4(t4, e7, o11) : ((t5, e8, o12) => {
    const r9 = e8.hasOwnProperty(o12);
    return e8.constructor.createProperty(o12, t5), r9 ? Object.getOwnPropertyDescriptor(e8, o12) : void 0;
  })(t4, e7, o11);
}
...
function e5(e7, r9) {
  return (n8, s6, i11) => {
    const o11 = (t4) => t4.renderRoot?.querySelector(e7) ?? null;
    if (r9) {
      ...
      return e4(n8, s6, { get() {
        let t4 = e8.call(this);
        return void 0 === t4 && (t4 = o11(this), (null !== t4 || this.hasUpdated) && r10.call(this, t4)), t4;
      } });
    }
    return e4(n8, s6, { get() {
      return o11(this);
...
var d3 = (n8, t4, r9, i11) => {
  for (var e7 = void 0, s6 = n8.length - 1, o11; s6 >= 0; s6--)
    (o11 = n8[s6]) && (e7 = o11(t4, r9, e7) || e7);
...
var f3 = class extends i4 {
  ...
  componentClassNames(t4, r9 = {}) {
    return (0, import_classnames.default)(t4, this.styleModifier, r9);
  }
  /**
   ...
   */
  dispatch({ e: t4, eventName: r9, detailObj: i11 = {}, optionsObj: e7 = {} }) {
    const s6 = {
      bubbles: true,
      composed: true,
      ...e7,
      detail: { ...t4 && { originalEvent: t4 }, ...i11 }
    }, o11 = new CustomEvent(r9, s6);
    return this.dispatchEvent(o11), o11;
  }
  /**
...
var J = (r9, t4) => {
  ...
  let i11, n8 = t4 === 2 ? "<svg>" : t4 === 3 ? "<math>" : "", o11 = y3;
  for (let A2 = 0; A2 < e7; A2++) {
    const h6 = r9[A2];
    let a6, c8, l6 = -1, _2 = 0;
    for (; _2 < h6.length && (o11.lastIndex = _2, c8 = o11.exec(h6), c8 !== null); ) _2 = o11.lastIndex, o11 === y3 ? c8[1] === "!--" ? o11 = R2 : c8[1] !== void 0 ? o11 = B2 : c8[2] !== void 0 ? (V2.test(c8[2]) && (i11 = RegExp("</" + c8[2], "g")), o11 = p5) : c8[3] !== void 0 && (o11 = p5) : o11 === p5 ? c8[0] === ">" ? (o11 = i11 ?? y3, l6 = -1) : c8[1] === void 0 ? l6 = -2 : (l6 = o11.lastIndex - c8[2].length, a6 = c8[1], o11 = c8[3] === void 0 ? p5 : c8[3] === '"' ? O : D) : o11 === O || o11 === D ? o11 = p5 : o11 === R2 || o11 === B2 ? o11 = y3 : (o11 = p5, i11 = void 0);
    const d7 = o11 === p5 && r9[A2 + 1].startsWith("/>") ? " " : "";
    n8 += o11 === y3 ? h6 + q : l6 >= 0 ? (s6.push(a6), h6.slice(0, l6) + W + h6.slice(l6) + u3 + d7) : h6 + u3 + (l6 === -2 ? A2 : d7);
  }
...
var x2 = class _x {
  constructor({ strings: t4, _$litType$: e7 }, s6) {
    ...
    this.parts = [];
    let n8 = 0, o11 = 0;
    const A2 = t4.length - 1, h6 = this.parts, [a6, c8] = J(t4, e7);
    ...
    for (; (i11 = g2.nextNode()) !== null && h6.length < A2; ) {
      if (i11.nodeType === 1) {
        if (i11.hasAttributes()) for (const l6 of i11.getAttributeNames()) if (l6.endsWith(W)) {
          const _2 = c8[o11++], d7 = i11.getAttribute(l6).split(u3), N2 = /([.?@])?(.*)/.exec(_2);
          h6.push({ type: 1, index: n8, name: N2[2], strings: d7, ctor: N2[1] === "." ? Q : N2[1] === "?" ? X : N2[1] === "@" ? Y : M2 }), i11.removeAttribute(l6);
        } else l6.startsWith(u3) && (h6.push({ type: 6, index: n8 }), i11.removeAttribute(l6));
        if (V2.test(i11.tagName)) {
          const l6 = i11.textContent.split(u3), _2 = l6.length - 1;
          if (_2 > 0) {
            i11.textContent = T2 ? T2.emptyScript : "";
            for (let d7 = 0; d7 < _2; d7++) i11.append(l6[d7], b3()), g2.nextNode(), h6.push({ type: 2, index: ++n8 });
            i11.append(l6[_2], b3());
          }
        }
        ...
        let l6 = -1;
        for (; (l6 = i11.data.indexOf(u3, l6 + 1)) !== -1; ) h6.push({ type: 7, index: n8 }), l6 += u3.length - 1;
      }
      n8++;
    }
  }
...
var K = class {
  ...
  u(t4) {
    ...
    g2.currentNode = i11;
    let n8 = g2.nextNode(), o11 = 0, A2 = 0, h6 = s6[0];
    for (; h6 !== void 0; ) {
      if (o11 === h6.index) {
        let a6;
      ...
      o11 !== h6?.index && (n8 = g2.nextNode(), o11++);
    }
...
var C2 = class _C {
  ...
  $(t4) {
    ...
    if (this._$AH?._$AD === i11) this._$AH.p(e7);
      ...
      const n8 = new K(i11, this), o11 = n8.u(this.options);
      n8.p(e7), this.T(o11), this._$AH = n8;
    }
  }
  _$AC(t4) {
...
var M2 = class {
  ...
  _$AI(t4, e7 = this, s6, i11) {
    ...
    let o11 = false;
    if (n8 === void 0) t4 = m2(this, t4, e7, 0), o11 = !H2(t4) || t4 !== this._$AH && t4 !== v2, o11 && (this._$AH = t4);
    else {
      const A2 = t4;
      let h6, a6;
      for (t4 = n8[0], h6 = 0; h6 < n8.length - 1; h6++) a6 = m2(this, A2[s6 + h6], e7, h6), a6 === v2 && (a6 = this._$AH[h6]), o11 ||= !H2(a6) || a6 !== this._$AH[h6], a6 === $2 ? t4 = $2 : t4 !== $2 && (t4 += (a6 ?? "") + n8[h6 + 1]), this._$AH[h6] = a6;
    }
    o11 && !i11 && this.j(t4);
  }
  j(t4) {
...
var c4 = (l6, e7, i11, w3) => {
  for (var o11 = void 0, h6 = l6.length - 1, s6; h6 >= 0; h6--)
    (s6 = l6[h6]) && (o11 = s6(e7, i11, o11) || o11);
  return o11 && v3(e7, i11, o11), o11;
};
...
var o8 = (u5, t4, n8, i11) => {
  for (var a6 = void 0, l6 = u5.length - 1, s6; l6 >= 0; l6--)
    (s6 = u5[l6]) && (a6 = s6(t4, n8, a6) || a6);
  return a6 && y4(t4, n8, a6), a6;
};
var b4 = class b5 extends a4 {
  ...
  createButton(t4) {
    const n8 = this.getIconElement(), i11 = this.getSpinnerElement();
    return x`
      <button type="${this.type}" class="${t4}" ?disabled=${this.disabled || this.isLoading}
        aria-busy=${this.isLoading ? "true" : E} @click=${this.clickHandler}>
        ${this.isLoading ? i11 : this.iconPosition === "before" ? n8 : E}
        <span class="${this.hideText ? "ed-u-is-vishidden ed-c-button__text" : "ed-c-button__text"}"><slot>${this.text}</slot></span>
        ${!this.isLoading && this.iconPosition === "after" ? n8 : E}
      </button>
    `;
  }
...
var b6 = (o11, t4, r9, p10) => {
  for (var e7 = void 0, n8 = o11.length - 1, i11; n8 >= 0; n8--)
    (i11 = o11[n8]) && (e7 = i11(t4, r9, e7) || e7);
...
customElements.get("ed-grid") === void 0 && customElements.define("ed-grid", i5);

// node_modules/@brad-frost-web/eddie-web-components/components/grid-item/grid-item.js
var i6 = ":root,:host{--size-base-unit: .5rem}*,::slotted(*),*:before,*:after{box-sizing:border-box}h1,h2,h3,h4,h5,h6{margin:0}:host{display:block}.ed-c-grid__item{height:100%}";
...
var d5 = (h6, e7, n8, s6) => {
  for (var t4 = void 0, l6 = h6.length - 1, o11; l6 >= 0; l6--)
    (o11 = h6[l6]) && (t4 = o11(e7, n8, t4) || t4);
...
var u4 = (r9, e7, n8, p10) => {
  for (var t4 = void 0, o11 = r9.length - 1, a6; o11 >= 0; o11--)
    (a6 = r9[o11]) && (t4 = a6(e7, n8, t4) || t4);
...
var h4 = '@charset "UTF-8";:root,:host{--size-base-unit: .5rem}*,::slotted(*),*:before,*:after{box-sizing:border-box}h1,h2,h3,h4,h5,h6{margin:0}:host{display:block}.ed-c-section{margin-block-end:2rem}.ed-c-section__body{padding-block-start:1rem}@media all and (min-width:60rem){.ed-c-section__body{padding-block-start:2rem}}.ed-c-section--align-center .ed-c-section-header{text-align:center}';
var p8 = Object.defineProperty;
var f5 = (n8, e7, o11, s6) => {
  for (var t4 = void 0, r9 = n8.length - 1, i11; r9 >= 0; r9--)
    (i11 = n8[r9]) && (t4 = i11(e7, o11, t4) || t4);
  return t4 && p8(e7, o11, t4), t4;
};
var d6 = class extends f3 {
  ...
  /**
   * Whether the default slot has content: any element child without a slot
   * attribute, or a non-empty text node. A header-only section must not
   * render the body wrapper — its responsive padding-block-start otherwise
   * renders as phantom dead space (#1044).
   */
  defaultSlotEmpty() {
    const e7 = Array.from(this.children).some((s6) => !s6.hasAttribute("slot")), o11 = Array.from(this.childNodes).some(
      (s6) => s6.nodeType === Node.TEXT_NODE && s6.textContent?.trim() !== ""
    );
    return !e7 && !o11;
  }
  render() {
    const e7 = this.componentClassNames("ed-c-section", {
    ...
    return x`
      <section class="${e7}">
        ...
        ${this.defaultSlotEmpty() ? "" : x`<div class="ed-c-section__body">
              <slot></slot>
            </div>`}
      </section>
    `;
...
var o9 = (h6, e7, t4, f7) => {
  for (var a6 = void 0, l6 = h6.length - 1, n8; l6 >= 0; l6--)
    (n8 = h6[l6]) && (a6 = n8(e7, t4, a6) || a6);
...
var r7 = class extends f3 {
  ...
  connectedCallback() {
    if (super.connectedCallback(), !document.head.querySelector("#ed-text-passage-styles")) {
      ...
      t4.id = "ed-text-passage-styles", t4.innerHTML = g4, document.head.appendChild(t4);
    }
  }
  render() {
    const e7 = this.componentClassNames("ed-c-text-passage", {
      "ed-c-text-passage--knockout": this.knockout || this.inverted,
...
var h5 = (r9, t4, n8, c8) => {
  for (var e7 = void 0, o11 = r9.length - 1, s6; o11 >= 0; o11--)
    (s6 = r9[o11]) && (e7 = s6(t4, n8, e7) || e7);
  return e7 && b7(t4, n8, e7), e7;
};
...
customElements.get("ed-r-course-banner") === void 0 && customElements.define("ed-r-course-banner", o10);
...
var n7 = (o11, i11, t4, _2) => {
  for (var e7 = void 0, r9 = o11.length - 1, s6; r9 >= 0; r9--)
    (s6 = o11[r9]) && (e7 = s6(i11, t4, e7) || e7);
  return e7 && g5(i11, t4, e7), e7;
};
...
var i10 = (a6, o11, n8, _2) => {
  for (var d7 = void 0, s6 = a6.length - 1, l6; s6 >= 0; s6--)
    (l6 = a6[s6]) && (d7 = l6(o11, n8, d7) || d7);
  return d7 && g6(o11, n8, d7), d7;
};
var r8 = class extends f3 {
  ...
  render() {
    const o11 = this.componentClassNames("ed-r-project-card", {
